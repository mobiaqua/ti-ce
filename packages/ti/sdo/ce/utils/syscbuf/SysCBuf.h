...
#define ti_sdo_ce_utils_syscbuf_SysCBuf___VERS 160
...
__extern xdc_Void ti_sdo_ce_utils_syscbuf_SysCBuf_abort__E( xdc_CString str );
xdc__CODESECT(ti_sdo_ce_utils_syscbuf_SysCBuf_abort__F, "ti_sdo_ce_utils_syscbuf_SysCBuf_abort")
__extern xdc_Void ti_sdo_ce_utils_syscbuf_SysCBuf_abort__F( xdc_CString str );
__extern xdc_Void ti_sdo_ce_utils_syscbuf_SysCBuf_abort__R( xdc_CString str );
