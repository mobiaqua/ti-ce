This directory contains zipped examples for the C6472 platform.
...
1. Unpack all C6472 examples into the root of the examples folder.

$ unzip archive/C6472/\*.zip


2. From the C6472 folder, unpack all examples to a destination folder.
...
ex01_universalcopy_bios_core0:
    Local BIOS universal_copy codec example for dsp core0.

ex01_universalcopy_bios_remote:
    Remote BIOS universal_copy codec example for dsp core0, with servers for
    cores 1, 2, 3, 4, and 5.
