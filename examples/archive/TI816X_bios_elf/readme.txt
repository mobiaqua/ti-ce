This directory contains zipped examples for the TI816X platform.
...
1. Unpack all TI816X examples into the root of the examples folder.

$ unzip archive/TI816X/\*.zip


2. From the TI816X folder, unpack all examples to a destination folder.
