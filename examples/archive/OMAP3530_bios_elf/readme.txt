This directory contains zipped examples for the OMAP3530 platform.
...
1. Unpack all OMAP3530 examples into the root of the examples folder.

$ unzip archive/OMAP3530/\*.zip


2. From the OMAP3530 folder, unpack all examples to a destination folder.
